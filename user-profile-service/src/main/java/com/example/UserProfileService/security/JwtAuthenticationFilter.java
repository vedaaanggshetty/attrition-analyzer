 ...
 * success. Mirrors authentication-service's filter of the same name - each
 * service owns its own copy since there is no shared library in this
 * project.
 *
 ...
 * 401/403 is produced by Spring Security's normal authorization rules.
 */
@Component
