...
export function AppLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-brand-50/40">
      ...
      <aside
        className={cx(
          "fixed inset-y-0 left-0 z-40 flex w-64 shrink-0 flex-col border-r border-brand-900/10 bg-white px-5 py-6 transition-transform duration-300 lg:static lg:translate-x-0",
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-20 flex h-16 items-center gap-4 border-b border-brand-900/10 bg-white/80 px-5 backdrop-blur-xl lg:px-8">
          <button
            type="button"
