        ...
        <div ref={ref} className="grid gap-5 lg:grid-cols-5">
          <Card className="relative overflow-hidden p-7 lg:col-span-3" data-reveal>
            <span
              ref={numeralRef}
              aria-hidden="true"
              className="pointer-events-none absolute -bottom-8 -right-4 select-none font-display font-bold text-ink-900/[0.04]"
              style={{ fontSize: "clamp(5rem, 16vw, 10rem)", lineHeight: 1, transform: `translateY(${numeralOffset}px)` }}
            >
              {department?.[0]?.attritionRate ?? ""}
            </span>
            <div className="relative">
              <h3 className="font-serif text-lg font-semibold text-ink-900">Attrition by Department</h3>
              <p className="mt-1 text-base text-neutral-500">Highest-risk departments, ranked</p>
              <div className="mt-6">
          ...
          <Card className="p-7 lg:col-span-2" data-reveal>
            <h3 className="font-serif text-lg font-semibold text-ink-900">Attrition by Job Role</h3>
            <p className="mt-1 text-base text-neutral-500">Where turnover concentrates</p>
            <div className="mt-6">
