...
public class SecurityConfig {
    ...
    // health, and the unified Swagger UI/docs. Every other route proxied by
    ...
    // (not Spring Security's default 403) via the custom entry point below.
    @Bean
    ...
    // Allows the frontend (a separate origin - Vite dev server or a future
    // static host) to call this Gateway from the browser. Every other
    // service in this project is called only through the Gateway, so this
    // is the single place CORS needs to be configured.
    @Bean
